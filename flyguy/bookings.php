...
<body>
	...
	<p><h1>My Booked Flights</h1></p>
			<table class="table">
				...
				<?php
					$getFlights=$db->query("SELECT flight.*,bookings.bookingDate FROM flight inner join bookings on bookings.flightID=flight.flightID WHERE bookings.memberID='$session_id'");
